package dariojolo.com.ejerciciorealm.activities;
...
import dariojolo.com.ejerciciorealm.adapters.CiudadAdapter;
...
public class MainActivity extends AppCompatActivity implements RealmChangeListener<RealmResults<Ciudad>>, AdapterView.OnItemClickListener{
    ...
    private RecyclerView listaCiudades;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ciudades = getAllCiudad();
        layoutManager = new LinearLayoutManager(this);
        listaCiudades = (RecyclerView)findViewById(R.id.listaCiudades);
        adapter = new CiudadAdapter(ciudades, R.layout.lista_item, this, new CiudadAdapter.OnItemClickListener() {
            @Override
    ...
    @Override
    public void onChange(RealmResults<Ciudad> element) {
        adapter.notifyDataSetChanged();
    }
}
